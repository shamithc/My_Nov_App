class Facebook < ActiveRecord::Base
  ...
  class << self
    ...
    def identify(fb_user)
     #Facebook.find_or_create_by_identifier_and_access_token(fb_user.identifier.try(:to_s),fb_user.access_token.access_token) 
     #session[:current_user]= @data.identifier
